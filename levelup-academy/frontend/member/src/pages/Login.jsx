  ...
  return (
    <div className="relative min-h-screen grid lg:grid-cols-2 bg-base-200">
      ...
      <div className="relative hidden lg:flex flex-col justify-between overflow-hidden bg-sidebar text-neutral-content p-12">
        ...
        <img src={`${import.meta.env.BASE_URL}wba-logo-white.png`} alt="World Bridge Academy" className="relative h-14 w-auto self-start object-contain" />
      ...
      <div className="grid place-items-center p-6">
        <div className="w-full max-w-md">
          <img src={`${import.meta.env.BASE_URL}wba-logo.png`} alt="World Bridge Academy" className="h-14 w-auto mb-6 lg:hidden object-contain" />
